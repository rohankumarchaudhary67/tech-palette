                ...
                <Link href="/" className="mb-4 inline-block">
                  <div className="flex justify-center items-center">
                    <Image
                      ...
                      className=""
                    />
                    <h1 className="font-bold text-xl md:text-3xl">TechPalette</h1>
                  </div>
                </Link>
                <p className="mb-4 text-base font-medium leading-relaxed text-body-color">
                  Turning your digital vision into reality
                </p>
        ...
        <div className="bg-primary/10 py-8">
          <div className="container">
            <p className="text-center text-base text-body-color dark:text-white">
              CopyRights © 2021 - Present TechPalette. All rights reserved.
            </p>
          </div>
        </div>
